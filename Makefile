...
$(B)/client/q_shared.o : $(CMDIR)/q_shared.cpp; $(DO_CC)
$(B)/client/q_math.o : $(CMDIR)/q_math.cpp; $(DO_CC)
...
$(B)/client/unix_net.o : $(UDIR)/unix_net.cpp; $(DO_CC)
...
$(B)/client/linux_glimp.o : $(UDIR)/linux_glimp.cpp; $(DO_CC)  $(GL_CFLAGS)
$(B)/client/sdl_glimp.o : $(UDIR)/sdl_glimp.cpp; $(DO_CC)  $(GL_CFLAGS)
$(B)/client/linux_glimp_smp.o : $(UDIR)/linux_glimp.cpp; $(DO_SMP_CC)  $(GL_CFLAGS)
$(B)/client/sdl_glimp_smp.o : $(UDIR)/sdl_glimp.cpp; $(DO_SMP_CC)  $(GL_CFLAGS)
$(B)/client/linux_joystick.o : $(UDIR)/linux_joystick.cpp; $(DO_CC)
$(B)/client/linux_qgl.o : $(UDIR)/linux_qgl.cpp; $(DO_CC)  $(GL_CFLAGS)
$(B)/client/linux_input.o : $(UDIR)/linux_input.cpp; $(DO_CC)
$(B)/client/linux_snd.o : $(UDIR)/linux_snd.cpp; $(DO_CC)
$(B)/client/sdl_snd.o : $(UDIR)/sdl_snd.cpp; $(DO_CC)
