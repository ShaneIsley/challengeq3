...
// these two are legacyhax from the days of substandard OGL support
// we keep them around because glconfig_t is also used by the cgame vm so the layout has to match
typedef enum { GLDRV_ICD } glDriverType_t;
typedef enum { GLHW_GENERIC } glHardwareType_t;
