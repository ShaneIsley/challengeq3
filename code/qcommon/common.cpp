...
typedef std::stack<sysEvent_t, std::list<sysEvent_t, q3allocator<sysEvent_t> > > comEvenets_t;
...
static sysEvent_t Com_GetEvent()
{
	...
	{
		sysEvent_t tmp( Com_PushedEvenets().top() );
		Com_PushedEvenets().pop();
		return tmp;
	}
