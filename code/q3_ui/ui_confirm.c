...
static void MessageMenu_Draw( void ) {
	...
	{
		UI_DrawProportionalString( 320, y, s_confirm.lines[i], s_confirm.style, colorRed );
		y += 18;
	}
...
static void ConfirmMenu_Draw( void ) {
	UI_DrawNamedPic( 142, 118, 359, 256, ART_CONFIRM_FRAME );
	UI_DrawProportionalString( 320, 204, s_confirm.question, s_confirm.style, colorRed );
	UI_DrawProportionalString( s_confirm.slashX, 265, "/", UI_LEFT|UI_INVERSE, colorRed );
