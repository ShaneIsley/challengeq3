...
static void UI_CinematicsMenu_Init( void ) {
	...
	cinematicsMenuInfo.banner.color				= colorWhite;
	...
	cinematicsMenuInfo.cin_idlogo.color				= colorRed;
	...
	cinematicsMenuInfo.cin_intro.color				= colorRed;
	...
	cinematicsMenuInfo.cin_tier1.color				= colorRed;
	...
	cinematicsMenuInfo.cin_tier2.color				= colorRed;
	...
	cinematicsMenuInfo.cin_tier3.color				= colorRed;
	...
	cinematicsMenuInfo.cin_tier4.color				= colorRed;
	...
	cinematicsMenuInfo.cin_tier5.color				= colorRed;
	...
	cinematicsMenuInfo.cin_tier6.color				= colorRed;
	...
	cinematicsMenuInfo.cin_tier7.color				= colorRed;
	...
	cinematicsMenuInfo.cin_end.color				= colorRed;
